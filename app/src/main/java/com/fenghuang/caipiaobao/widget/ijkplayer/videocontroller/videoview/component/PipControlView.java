package com.fenghuang.caipiaobao.widget.ijkplayer.videocontroller.videoview.component;
...
public class PipControlView extends FrameLayout implements IControlComponent, View.OnClickListener {
    ...
    private FrameLayout float_controller;
...
//        findViewById(R.id.btn_skip).setOnClickListener(this);
        float_controller = findViewById(R.id.float_controller);
        float_controller.setOnClickListener(this);
    }

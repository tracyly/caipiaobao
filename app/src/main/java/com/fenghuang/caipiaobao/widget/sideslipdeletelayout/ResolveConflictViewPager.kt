package com.fenghuang.caipiaobao.widget.sideslipdeletelayout
 ...
 */
open class ResolveConflictViewPager @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : ViewPager(
        context,
        attrs
) {

package com.fenghuang.caipiaobao.widget.password;
...
import static com.fenghuang.caipiaobao.widget.ijkplayer.controller.util.PlayerUtils.dp2px;
...
public class PasswordInput extends EditText {
    ...
    //============================= Z-方块 ==============================/
    private int boxCount = 6; //字符方块的数量
    ...
    private void getDefaultVar() {
        borderNotFocusedColor = getColor(getContext(), R.color.color_f5f5f5);
        borderFocusedColor = getColor(getContext(), R.color.color_f5f5f5);
    }
    ...
    private void startTextChangedAnim(boolean isAdd) {
        ...
        if (scans.length >= currTextLen) {
            ...
            scanAnim.addUpdateListener(valueAnimator -> {

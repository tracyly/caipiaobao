...
public class AndSelectCircleView extends RadioGroup {
    ...
    public AndSelectCircleView(Context context, AttributeSet attrs) {
        ...
        mChildWidth = attributes.getDimensionPixelSize(R.styleable.AndSelectCircleView_child_width, ViewUtils.INSTANCE.dp2px(DEAFULT_CHILD_SIZE));
        mChildHeight = attributes.getDimensionPixelSize(R.styleable.AndSelectCircleView_child_height, ViewUtils.INSTANCE.dp2px(DEAFULT_CHILD_SIZE));
        mChildMargin = attributes.getDimensionPixelSize(R.styleable.AndSelectCircleView_child_margin, ViewUtils.INSTANCE.dp2px(DEFAULT_CHILD_MARGIN));
    ...
    private void initView() {
        mChildHeight = ViewUtils.INSTANCE.dp2px(DEAFULT_CHILD_SIZE);
        mChildWidth = ViewUtils.INSTANCE.dp2px(DEAFULT_CHILD_SIZE);
        mChildMargin = ViewUtils.INSTANCE.dp2px(DEFAULT_CHILD_MARGIN);
    }

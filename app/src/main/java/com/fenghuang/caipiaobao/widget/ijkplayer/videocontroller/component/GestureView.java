...
import com.fenghuang.caipiaobao.widget.ijkplayer.videocontroller.videoplayer.controller.IGestureComponent;
import com.fenghuang.caipiaobao.widget.ijkplayer.videocontroller.videoplayer.player.VideoView;

import static com.fenghuang.caipiaobao.widget.ijkplayer.videocontroller.videoplayer.util.PlayerUtils.stringForTime;
...
public class GestureView extends FrameLayout implements IGestureComponent {
    ...
    public void onPositionChange(int slidePosition, int currentPosition, int duration) {
        ...
        if (slidePosition > currentPosition) {
            mIcon.setImageResource(R.drawable.ic_player_action_fast_forward);
        } else {
            mIcon.setImageResource(R.drawable.ic_player_action_fast_rewind);
        }
    ...
    public void onBrightnessChange(int percent) {
        ...
        mIcon.setImageResource(R.drawable.ic_player_action_brightness);
    ...
    public void onVolumeChange(int percent) {
        ...
        mProgressPercent.setVisibility(VISIBLE);
        if (percent <= 0) {
            mIcon.setImageResource(R.drawable.ic_player_action_volume_off);
        } else {
            mIcon.setImageResource(R.drawable.ic_player_action_volume_up);
        }
        mTextPercent.setText(percent + "%");
        mProgressPercent.setProgress(percent);
    }

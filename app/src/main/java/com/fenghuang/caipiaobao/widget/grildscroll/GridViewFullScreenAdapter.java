 ...
 * @ Describe
 */
public class GridViewFullScreenAdapter extends BaseAdapter {
    ...
    public GridViewFullScreenAdapter(Context context, List<HomeLiveChatGifBean> mDatas, int curIndex) {
...
//        return mDatas.get(position + curIndex * pageSize);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_home_full_screen_entrance, parent, false);
        ...
        if (model.isSelect() && model.getName().equals(itemName)) {//被选中
            ...
            viewHolder.item_layout.setBackgroundResource(R.color.transparent);
        }
        return convertView;
    }

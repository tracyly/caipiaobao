...
public class VideoViewManager {
     ...
     * 保存VideoView的容器
     */
    private LinkedHashMap<String, DanmukuVideoView> mVideoViews = new LinkedHashMap<>();
    /**
     * 是否在移动网络下直接播放视频
     */
     ...
     */
    public void add(DanmukuVideoView videoView, String tag) {
    ...
    public DanmukuVideoView get(String tag) {

...
class ChatFullGifTabView : FrameLayout {
    ...
    private fun setTabSelectStyle(selectView: TextView, unSelectView: TextView, unSelectView2: TextView, unSelectView3: TextView, unSelectView4: TextView) {
        ...
        unSelectView3.setTextColor(ViewUtils.getColor(R.color.white))
        unSelectView3.typeface = Typeface.defaultFromStyle(Typeface.NORMAL)
        unSelectView3.textSize = 15f
        unSelectView4.setTextColor(ViewUtils.getColor(R.color.white))
     ...
     * 选中状态，前面的选中，后面的未选中
     */
    private fun setTabSelectLineVisib(selectView: RoundTextView, unSelectView: RoundTextView, unSelectView2: TextView, unSelectView3: RoundTextView, unSelectView4: RoundTextView) {

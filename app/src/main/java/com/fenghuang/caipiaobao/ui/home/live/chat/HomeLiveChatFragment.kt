...
//import kotlinx.android.synthetic.main.fragment_live_chat.liveChatEmptyContainer
//import kotlinx.android.synthetic.main.fragment_live_chat.rewardLayout
...
////            } else if (oldBottom != 0 && bottom != 0 && (bottom - oldBottom > mKeyHeight) && mEmoticonKeyboards.visibility != VISIBLE) {
////                    setVisible(ivGift)
...
//        })
//        // 输入框的发送按钮事件
//        chatEditText.setOnKeyListener(View.OnKeyListener { _, keyCode, event ->

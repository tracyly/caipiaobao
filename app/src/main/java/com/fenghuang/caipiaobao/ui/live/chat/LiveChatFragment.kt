...
class LiveChatFragment : BaseMultiRecyclerFragment<LiveCharPresenter>() {
    ...
    override fun attachPresenter() = LiveCharPresenter(getPageActivity())
    override fun initPageView() {
        super.initPageView()
        SoftHideKeyBoardUtil().init(getPageActivity())
        register(LiveChatBean::class.java, LiveChatHolder())

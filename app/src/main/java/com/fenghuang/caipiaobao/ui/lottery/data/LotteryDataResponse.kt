...
data class LotteryExpertPlanResponse(var id: Int, var lottery_id: Int, var issue: String, var code: String, var hit_rate: String, var created: String, var avatar: String, var nickname: String, var method: String)

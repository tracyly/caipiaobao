...
////                                UserInfoSp.getUserNickName().toString(), "", "", mView.anchorName, "0".toFloat(), "0", UserInfoSp.getVipLevel().toString(), "", "0", "", 0))
//                    }
//                }
//            }
//        }
...
////                        mView.onIsShowRedEnvelope(HomeLiveRedMessageBean("4", homeLiveRedRoom.id.toString(), "", ""))
////                        RxBus.get().post(HomeLiveRedMessageBean("4", homeLiveRedRoom.id.toString(), "", ""))
//                    }
//                }
//            }
//            onFailed {
...
//        HomeApi.getSettingPayPassword("", newPassword) {
//            onSuccess {
//                if (mView.isActive()) {
//
